...
public class MainActivity extends BaseActivity {
	...
	private void initTitleBar() {
		...
		titleBar.addAction(
				new TitleBar.Action().setDrawable(R.drawable.ic_back_selector)
	...
	private void configLocation() {
		...
		baiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
			...
			public boolean onMarkerClick(Marker marker) {
				...
				String toast = String.format(Locale.getDefault(),
						"Latitide: %f, Longitude: %f", position.latitude,
						position.longitude);
	...
	private BDLocationListener locationListener = new BDLocationListener() {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			Logger.d("lat: %f, lon: %f, radius: %f, direction: %f",
					location.getLatitude(), location.getLongitude(),
					location.getRadius(), location.getDirection());
			...
			if (isFirstLocation) {
				...
				OverlayOptions overlay = new MarkerOptions()
						...
						.icon(BitmapDescriptorFactory
								.fromResource(R.drawable.ic_overlay)).zIndex(0)
						.draggable(false);
